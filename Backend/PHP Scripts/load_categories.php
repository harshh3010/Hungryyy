...
$sql = $connect->query("SELECT DISTINCT category_id,category_name FROM dishes WHERE city_name='$city_name' AND state_name='$state_name' AND country_name='$country_name'");
$res = array();
